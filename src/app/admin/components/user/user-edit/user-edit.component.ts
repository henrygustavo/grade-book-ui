    ...
    const formSubscription = this._route.params.subscribe(
      ...
      (params): void => {
        ...
        this.mainForm = this.formBuilder.group({
          ...
          userName: new FormControl({ value: ''}, [Validators.required, CustomValidators.rangeLength([8, 10])]),
          email: new FormControl({ value: '' }, [Validators.required, Validators.minLength(4), CustomValidators.email]),
          password: password,
